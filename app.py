...
st.caption("Live Kalshi weather prices compared with GFS ensemble probabilities. Research tool, not a profit guarantee.")
...
for rank, (_, r) in enumerate(qualified.iterrows(), start=1):
    ...
    with st.container(border=True):
        ...
        if r["contract_url"]:
            st.link_button("Open this Kalshi weather series ↗", r["contract_url"])
